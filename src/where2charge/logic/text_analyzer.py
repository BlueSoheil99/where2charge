...
class TextAnalyzer:
    def __init__(self, api_key):
        ...
        self.system_content = (
            "Act as an electric vehicle owner who wants to charge their EV based"
            ...
            "The value of each key is an integer between 1" 
            " and number of input EV charging stations."
            ...
            "\"Reviews\":\"[\\'William Gibbs: One star because ALL chargers"
            "at this location are out"
    ...
    def LLM_analyze(self, data:pd.DataFrame):
        ...
        :param data:
        :return: updated data with a new column 'LLM rank'.
        Best suggestion has a value of one under this column
        """
        ...
        try:
            ...
            raise RuntimeError("Failed to process DataFrame. Check the input format.") from e
        try:
            ...
            raise RuntimeError("Failed to get a response from OpenAI API.") from e
